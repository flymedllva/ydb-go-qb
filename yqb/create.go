...
func (d *createStmt) ToSql() (sqlStr string, args []any, err error) {
...
func (d *createStmt) toSqlRaw() (sqlStr string, args []any, err error) {
	if len(d.Table) == 0 {
...
func (b CreateBuilder) ToSql() (string, []any, error) {
	data := builder.GetStruct(b).(createStmt)
	return data.ToSql()
}

// ToYdbSql builds the query into a SQL string and bound args.
func (b CreateBuilder) ToYdbSql() (string, []table.ParameterOption, error) {
...
func (b CreateBuilder) Prefix(sql string, args ...any) CreateBuilder {
...
func (b CreateBuilder) PrimaryKey(sql string, args ...any) CreateBuilder {
...
func (b CreateBuilder) Suffix(sql string, args ...any) CreateBuilder {
