...
func (d *dropStmt) ToSql() (sqlStr string, args []any, err error) {
...
func (d *dropStmt) toSqlRaw() (sqlStr string, args []any, err error) {
	if len(d.Table) == 0 {
...
func (b DropBuilder) ToSql() (string, []any, error) {
	data := builder.GetStruct(b).(dropStmt)
	return data.ToSql()
}

// ToYdbSql builds the query into a SQL string and bound args.
func (b DropBuilder) ToYdbSql() (string, []table.ParameterOption, error) {
...
func (b DropBuilder) Prefix(sql string, args ...any) DropBuilder {
...
func (b DropBuilder) Suffix(sql string, args ...any) DropBuilder {
